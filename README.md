...
- [ ] **Notification Permission (Android 13+):** App starten → „Erinnerungen starten" tippen → Systemprompt erscheint → „Erlauben" gewährt Berechtigung, Snackbar zeigt `Erinnerungen gestartet ✅`; bei „Ablehnen" erscheint `Benachrichtigungen nicht erlaubt ❌`
...
| Hintergrund | WorkManager (Periodic + OneTime) |
