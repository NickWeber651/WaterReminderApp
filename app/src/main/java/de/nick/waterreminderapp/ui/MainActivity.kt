...
fun WaterReminderScreen() {
    ...
    Scaffold(
        ...
        Column(
            ...
            Spacer(Modifier.height(8.dp))
            Button(onClick = { scope.launch { intakeStore.addMl(250) } }, modifier = Modifier.fillMaxWidth()) {
                Text("+ 250 ml trinken")
            }
            Button(onClick = { requestPermissionAndStart() }, modifier = Modifier.fillMaxWidth()) {
